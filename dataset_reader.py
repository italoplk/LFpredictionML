...
training_dataset = pairwise_lister("../Original_LFs/png", "../Decoded_LFs/png/decoded_32_noPartition", ["Bikes", "Danger_de_Mort", "Fountain_&_Vincent_2", "Stone_Pillars_Outside"], exclude = True)
test_dataset = pairwise_lister("../Original_LFs/png", "../Decoded_LFs/png/decoded_32_noPartition", ["Bikes", "Danger_de_Mort", "Fountain_&_Vincent_2", "Stone_Pillars_Outside"], exclude = False)
